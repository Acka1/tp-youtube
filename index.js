...
// function save() {  
//      let iframe = document.getElementById("searchInput").value  
//    window.localStorage.setItem("iframe" + (+new Date()), iframe);   
//      window.location.reload() 
// };


// //récup clé les transfo en tableau
...
// html += iframe + `<button class="delete" style="position:relative;left-39px;top-10px" data-keys="${key}"></button>`
...
// window.localStorage.removeItem(button.database.key);
// window.location.reload()
